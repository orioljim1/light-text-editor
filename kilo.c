//Defines for other compilers compatiblitity
...
void editorDrawMessageBar(struct abuf *ab) {
	...
	if (msglen && time(NULL) - E.statusmsg_time < MESSAGE_TIMEOUT) abAppend(ab, E.statusmsg, msglen);
}
...
void editorMoveCursor(int key){
	...
	//E.cx = MAX(0, E.cx);
	//E.cx = MIN(E.cx, E.screenrows-1);
	//E.cy = MAX(0, E.cy);
	//E.cy = MIN(E.cy, E.numrows + E.screenrows);
